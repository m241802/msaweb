...
move_uploaded_file($_FILES['upload']['tmp_name'], "uploads/img/".date("Y-m").'/'.$name);
$full_path = 'http://atrium-ceramic.ru/public/uploads/img/'.date("Y-m").'/'.$name;
$message = "Файл ".$_FILES['upload']['name']." загружен";
unlink('uploads/img/'.date("Y-m").'/'.$name);
